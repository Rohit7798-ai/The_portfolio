...
const Hero = React.memo(() => {
  ...
  const designations = useMemo(() => ["BSc Data Science Student", "Data Analyst", "ML Explorer", "Dashboard Developer"], []);
          ...
          <AnimateOnScroll animation="slide-up">
            <div className={`text-center lg:text-left transition-all duration-1000 ${mounted ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              ...
              <p className="text-sm sm:text-base lg:text-lg text-forest-700 font-medium mb-6 sm:mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed">
                Raw data doesn't tell you much on its own. I do the work in between cleaning it, finding what matters, and presenting it in a way that drives real decisions. I use Python, Pandas, NumPy, Matplotlib, and Excel across the whole pipeline: from messy spreadsheets to finished dashboards.
              </p>
